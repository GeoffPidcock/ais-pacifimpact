...
vn.imts.bot <- fread('C:/Users/Avin/Documents/Data/Hackathon/AIS/ais-pacifimpact/data/external/Vanuatu IMTS cleaned.csv')
...
Prior to upload, the country_metrics table had 480 existing records. 
...
Prior to upload, the country_metrics table had 865 existing records. 
...
Prior to upload, the country_metrics table had 940 existing records. 
...
Prior to upload, the country_metrics table had 1140 existing records. 

After the upload, the same table has 1488 records. 

The difference equates to the 348 row count of the Cook Islands IMTS dataset. This means data was successfully uploaded. 
