...
# Trin
model.data.fj1.tr <- ts(model.data.fj[1:14], frequency = 12)
...
model.data.fj1 <- tslm(trade_volume ~ cargo_time_in_port_seconds + visitor_arrivals + tanker_time_in_port_seconds, data = model.data.fj1.tr)
...
```{r}
predict(model.data.fj1, model.data.fj.tv)
